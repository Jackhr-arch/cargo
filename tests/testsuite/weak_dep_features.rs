...
"#]])
    ...
    fn missing_dependency_order_check_by_abc() {
        ...
        p.cargo("check")
            ...
            .with_stderr_data(str![[r#"
[UPDATING] `dummy-registry` index
[CHECK] Current we are activating bar_wrapper @ 1.1.2 to match the dependency bar_wrapper required by feat_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.2", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency the_feat required by bar

[CHECK] Current we are activating bar_wrapper @ 1.1.1 to match the dependency bar_wrapper required by feat_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.1", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency bar required by bar_wrapper

[Notice] No remaining candidates when trying to find a match for dependency bar_wrapper required by bar_activator

[CHECK] Current we are activating bar_wrapper @ 1.1.0 to match the dependency bar_wrapper required by feat_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.0", source: "registry `crates-io`" }: Semver}
...
[Notice] No remaining candidates when trying to find a match for dependency bar_wrapper required by feat_activator
...
"#]])
        ...
        p.cargo("check -Znext-lockfile-bump")
            ...
            .with_stderr_data(str![[r#"
[UPDATING] `dummy-registry` index
[CHECK] Current we are activating bar_wrapper @ 1.1.2 to match the dependency bar_wrapper required by bar_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.2", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency the_feat required by bar

[CHECK] Current we are activating bar_wrapper @ 1.1.1 to match the dependency bar_wrapper required by bar_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.1", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency bar required by bar_wrapper

[CHECK] Current we are activating bar_wrapper @ 1.1.0 to match the dependency bar_wrapper required by bar_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.0", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency bar_wrapper required by bar_activator
[WARNING] conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.0", source: "registry `crates-io`" }: Semver}

[CHECK] Current we are activating bar_wrapper @ 1.1.2 to match the dependency bar_wrapper required by bar_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.2", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency bar_wrapper required by bar_activator
[WARNING] conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.2", source: "registry `crates-io`" }: Semver}

[CHECK] Current we are activating bar_wrapper @ 1.1.1 to match the dependency bar_wrapper required by bar_activator, got conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.1", source: "registry `crates-io`" }: Semver}

[Notice] No remaining candidates when trying to find a match for dependency bar_wrapper required by bar_activator
[WARNING] conflicting_activations: {PackageId { name: "bar_wrapper", version: "1.1.1", source: "registry `crates-io`" }: Semver}
